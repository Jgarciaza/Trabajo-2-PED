...
```{r, fig.cap="\\label{fig2}Histograma Rendimiento", fig.pos="H", fig.height=4, fig.width=5}
...
La Figura  \ref{box} refuerza esta observación mostrando una gran cantidad de datos atípicos por encima del rango intercuartílico, confirmando la presencia de rendimientos excepcionalmente altos en ciertos cultivos.
...
```{r, fig.cap="\\label{fig3}Histograma Rendimiento", fig.pos="H", fig.height=3, fig.width=7}
